...
const docTemplateorchestrator = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.NodesResponse"
                        }
                    },
                    "500": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.DeleteNodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateSandboxRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/sandboxes": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.SandboxObjectsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Control-plane sandbox request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.CreateSandboxObjectRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.SandboxObjectResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.DeleteSandboxResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "handlers.DeleteSandboxResponse": {
            "type": "object",
            "properties": {
                "deleted": {
                    "type": "string"
        ...
        "handlers.ProxyResponse": {
            "type": "object",
            "additionalProperties": {}
        },
        "handlers.SandboxObjectResponse": {
            "type": "object",
            "properties": {
                "sandbox": {
        ...
        "handlers.SandboxObjectsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "model.CreateSandboxRequest": {
            ...
            "properties": {
                "containers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.CreateContainerRequest"
                    }
                },
                "egress": {
                    "type": "boolean"
        ...
        "types.CreateSandboxObjectRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
                ...
                "spec": {
                    "$ref": "#/definitions/types.SandboxSpec"
                }
            }
        },
        "types.Node": {
            ...
            "properties": {
                ...
                "resources": {
                    "$ref": "#/definitions/types.NodeResources"
                },
                "sandboxd_base_url": {
                    "type": "string"
                },
                ...
                "state": {
                    "$ref": "#/definitions/types.NodeState"
                },
                "success_streak": {
                    "type": "integer"
                },
        ...
        "types.SandboxSpec": {
            ...
            "properties": {
                "containers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.SandboxContainerSpec"
                    }
                },
                "egress": {
                    "type": "boolean"
...
// SwaggerInfoorchestrator holds exported Swagger Info so clients can modify it
var SwaggerInfoorchestrator = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "/",
	Schemes:          []string{"http"},
...
func init() {
	swag.Register(SwaggerInfoorchestrator.InstanceName(), SwaggerInfoorchestrator)
}
