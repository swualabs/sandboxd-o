...
const docTemplatesandboxd = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.NodeStatusResponse"
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.ReconcileResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.ListSandboxesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/httpserver.CreateSandboxResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.GetSandboxResponse"
                        }
                    },
                    "404": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.DeleteSandboxResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        "httpserver.ContainerLogsResponse": {
            "type": "object",
            "properties": {
                "container": {
                    "type": "string"
        ...
        "httpserver.NodeStatusResponse": {
            ...
            "properties": {
                ...
                "resources": {
                    "$ref": "#/definitions/model.NodeResourceSnapshot"
                }
            }
        },
...
// SwaggerInfosandboxd holds exported Swagger Info so clients can modify it
var SwaggerInfosandboxd = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "/",
	Schemes:          []string{"http"},
...
func init() {
	swag.Register(SwaggerInfosandboxd.InstanceName(), SwaggerInfosandboxd)
}
